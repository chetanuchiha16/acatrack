...
async def test_guard():
    ...
    async with AsyncSessionLocal() as session:
        ...
        try:
            ...
            print(
                "❌ Failure: Access was incorrectly GRANTED to unauthorized section 'A'!"
            )
        except HTTPException as e:
        ...
        try:
            ...
            print(
                "❌ Failure: Access was incorrectly GRANTED for a section-less query!"
            )
        except HTTPException as e:
            if e.status_code == 403:
                print(
        ...
        try:
            ...
            print(
                f"❌ Unexpected failure: Student access denied with status {e.status_code}: {e.detail}"
            )
        ...
        try:
            ...
            print(
                "❌ Failure: Access was incorrectly GRANTED to student in untaught section!"
            )
        except HTTPException as e:
            if e.status_code == 403:
                print(
