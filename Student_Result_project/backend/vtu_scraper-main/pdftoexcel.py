...
pdf_folder = Path(os.path.abspath("VTU_Results"))
...
for code in subject_codes:
    columns += [
        ...
        f"{code}_TOTAL", f"{code}_RESULT", f"{code}_CREDITS"
    ]
columns += ["TOTAL_MARKS", "TOTAL_FAILED_SUBJECTS", "PERCENTAGE", "TOTAL_CREDITS"]
    ...
    for line in text.splitlines():
        ...
        if len(parts) >= 7:
            ...
            if len(numbers) >= 3:
                ...
                # Credits from sem_credits mapping
