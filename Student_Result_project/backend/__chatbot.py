...
from models.paths import db_path  # path to your SQLite db
...
def fetch_student_data_from_db():
    ...
    for sem in SEMESTERS:
        try:
            ...
            print(f"❌ Error fetching data from '{sem}': {e}")
            continue
...
def main():
    ...
    for sn in sorted(student_data_map.keys()):
        print(student_data_map[sn]["student_name"])
    print("--------------------------\n")
    ...
    while True:
        ...
        if target_student_name in student_data_map:
            ...
            print(f"❌ Student '{target_student_name_input}' not found. Please check the name and try again.")
