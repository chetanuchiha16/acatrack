        ...
        {messages.map((msg, i) => (
          ...
          >
            ...
            >
              {/* Header */}
              {msg.type === "header" && (
                <h3 className="font-bold mb-2 text-lg">{msg.text}</h3>
              )}
                ...
                <details className="mt-2 bg-gray-700 rounded-lg p-2">
                  ...
                  <div className="mt-2">
                    {Object.keys(msg.data).length === 0 ? (
                      <p className="text-green-400">✅ No backlogs!</p>
                    ) : (
                      Object.entries(msg.data).map(([sem, subs]) => (
              ...
              {msg.type === "downloads" && (
                <div className="flex flex-col sm:flex-row gap-2 mt-2">
                  <button
                    ...
                    onClick={() =>
                      window.open(msg.downloadUrls.full, "_blank")
                    }
                  >
                    📥 Semester Report
                  </button>
                  <button
                    ...
                    onClick={() =>
                      window.open(msg.downloadUrls.backlog, "_blank")
                    }
                  >
                    📥 Backlog Report
                  </button>
