  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Projects */}
        <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mt-4">Projects</h3>
        ...
        {/* Internships */}
        <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mt-4">Internships</h3>
        ...
        {/* Summary */}
        <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-200 mt-4">Summary</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
