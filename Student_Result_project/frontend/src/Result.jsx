                ...
                <div className="w-full max-w-6xl mx-auto mt-8 p-6 rounded-xl bg-white dark:bg-[#1e1e1e] shadow-lg h-full">
                    ...
                    <div className="text-center">
                        <a
                            href={data.pdf_url}
                            download
                            className="inline-block px-6 py-2 rounded-full bg-blue-600  !text-white font-bold text-base hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all"
                        >
                            📄 Download Report
                        </a>
                    </div>
